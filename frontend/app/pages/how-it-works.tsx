...
export default function HowItWorks() {
  return (
    <>
      ...
      <div className="intro">
        ...
        <p>
          Fischietto supports identity verification through Google Workspace, or any other identity provider like Laser Romae. When signing in with Google, it returns a piece of data called
          {"  "}
          <a
  ...
  signature: V7QYQ98PqoeoE89uwmueaKxEGh8Ed...
        ...
        <p>
          ...
          from Google attesting to the payload data. This signature can only be generated by Google&apos;s private key (or any other identity provider's key like Laser Romae).
        </p>
        ...
        <p>
          ...
          <span className="inline-code">nonce</span> to the identity provider during the sign-in process, and they will include that in the signed JWT token payload.
        </p>
        <p>
        ...
        <p>
          Verifying authenticity of the account and message like above requires sharing the full JWT data (including name and email) with the verifier. Of course, this is not ideal for whistleblowers who seek to remain anonymous. To address this, we use
          <a
